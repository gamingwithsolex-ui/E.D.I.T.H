...
from edith.agents.prompt_loader import (
...
from edith.core.types import Message, Role, ToolCall, ToolResult
from edith.engine._stubs import InferenceEngine
from edith.tools._stubs import BaseTool, build_tool_descriptions
...
class NativeOpenHandsAgent(ToolUsingAgent):
    ...
    def _expand_urls(text: str) -> tuple[str, bool]:
        ...
        try:
            from edith.tools.web_search import WebSearchTool

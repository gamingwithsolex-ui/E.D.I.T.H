...
Routes incoming :class:`~edith.channels._stubs.ChannelMessage` objects
...
from edith.channels._stubs import BaseChannel, ChannelMessage
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~edith.agents._stubs.BaseAgent`
        subclass).
    max_workers:

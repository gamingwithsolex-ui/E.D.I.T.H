...
from edith.core.types import Conversation, Message, Role, ToolResult
...
class ToolUsingAgent(BaseAgent):
    ...
    def __init__(
        ...
        *,
        ...
        from edith.tools._stubs import ToolExecutor
        ...
        try:
            from edith.agents.loop_guard import LoopGuard, LoopGuardConfig

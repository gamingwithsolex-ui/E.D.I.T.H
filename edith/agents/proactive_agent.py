...
called from your app startup:
    ...
    from edith.agents.proactive_agent import register_cron
...
from edith.agents._stubs import AgentContext, AgentResult, ToolUsingAgent
from edith.core.config import load_config
from edith.core.registry import AgentRegistry
from edith.core.types import Message, Role, ToolCall
from edith.tools.approval_store import (
...
from edith.tools.proactive_tools import get_store
...
def _build_notification_channel(channel_spec: str) -> Optional[Any]:
    ...
    if channel_type == "imessage":
        from edith.channels._stubs import (
            BaseChannel,
            ChannelStatus,
        )
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from edith.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from edith.tools.channel_tools import ChannelSendTool
        from edith.tools.digest_collect import DigestCollectTool
        from edith.tools.proactive_tools import (
            CheckPermissionTool,

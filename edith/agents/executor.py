...
from edith.agents._stubs import AgentResult
from edith.agents.errors import (
    AgentTickError,
    EscalateError,
    FatalError,
    classify_error,
...
class AgentExecutor:
    ...
    def _invoke_agent(self, agent: dict) -> AgentResult:
        ...
        from edith.agents import AgentRegistry
        ...
        if router_policy_key and self._system:
            try:
                from edith.core.registry import RouterPolicyRegistry
    ...
    def _save_trace(
        ...
        from edith.core.types import StepType, Trace, TraceStep

...
::
    ...
    python -m edith.agents.hybrid.runner --cell minions-gaia-qwen27b-opus-3
...
from edith.agents._stubs import AgentContext, AgentResult
from edith.agents.hybrid._prompts import format_prompt as _format_prompt
...
def _score_swebench(task: Dict[str, Any], answer: str) -> Dict[str, Any]:
    ...
    from edith.evals.core.types import EvalRecord
    from edith.evals.scorers.swebench_harness import (
...
def _build_agent(cell: Dict[str, Any]):
    ...
    import edith.agents  # noqa: F401 — populate registry
...
def main(argv: Optional[List[str]] = None) -> int:
    p = argparse.ArgumentParser(
        prog="python -m edith.agents.hybrid.runner",

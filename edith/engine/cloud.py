...
from edith.engine._base import (
    EngineConnectionError,
    InferenceEngine,
    messages_to_dicts,
)
from edith.engine._stubs import StreamChunk
    ...
    def _generate_openai(
        ...
        **kwargs: Any,
        ...
        if response_format is not None:
            from edith.engine._stubs import ResponseFormat
            ...
            for part in parts:
                if hasattr(part, "function_call") and part.function_call:
                    ...
                    tc_dict: Dict[str, Any] = {
                        "id": f"google_{fc.name}_{uuid.uuid4().hex[:8]}",
                        "name": fc.name,
                    ...
                    if sig is not None:
                        ...
                        if len(self._thought_sigs) > 1000:
                            self._thought_sigs.clear()

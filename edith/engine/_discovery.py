...
from edith.engine._base import InferenceEngine
...
def _maybe_register_mining_sidecar_engine() -> None:
    ...
    """
    try:
        from edith.mining import Sidecar
        from edith.mining._constants import SIDECAR_PATH
    except ImportError:
        return
    ...
    from edith.engine._openai_compat import _OpenAICompatibleEngine

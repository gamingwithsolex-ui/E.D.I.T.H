...
from edith.agents._stubs import AgentContext, BaseAgent
from edith.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from edith.core.types import Message as MsgType
                    from edith.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("edith.server")
                    _logger.warning(

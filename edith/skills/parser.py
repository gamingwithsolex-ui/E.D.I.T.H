...
2. Tolerant pass — maps non-spec top-level fields to their canonical
   locations under metadata.edith.* via FIELD_MAPPING.
...
# stored under manifest.metadata["edith"][attr].
...
class SkillParser:
    ...
    def _build_manifest(
        ...
        captures unknown fields under metadata.edith.original_frontmatter,
        and merges metadata.edith.* into canonical fields.
        """
        ...
        oj_meta = dict(raw_metadata.get("edith") or {})
        ...
        for key, value in frontmatter.items():
            ...
            if key in FIELD_MAPPING:
                ...
                LOGGER.warning(
                    ...
                    "(value preserved in metadata.edith.original_frontmatter)",
                    key,
                    manifest.name,
                )

        # Merge metadata.edith.* into canonical fields (these override
        ...
        # Preserve unmapped fields under metadata.edith.original_frontmatter
        if unmapped:

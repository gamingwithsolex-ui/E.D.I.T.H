...
from edith.mining._models import get_pearl_model_spec, pearl_variant_for_base_model
from edith.mining._stubs import MiningCapabilities
...
def check_disk_free(path: Path) -> Tuple[bool, str]:
    from edith.mining._constants import MIN_FREE_DISK_GB

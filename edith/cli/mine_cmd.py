...
from edith.core.config import HardwareInfo, detect_hardware, load_config
from edith.core.registry import MinerRegistry
from edith.mining._constants import (
...
from edith.mining._discovery import (
    check_disk_free,
...
from edith.mining._docker import PearlDockerLauncher
from edith.mining._metrics import parse_gateway_metrics
from edith.mining._models import (
    get_pearl_model_spec,
    iter_pearl_model_specs,
    pearl_variant_for_base_model,
)
from edith.mining._stubs import Sidecar
from edith.mining.vllm_pearl import ensure_registered as ensure_vllm_registered
...
def _ensure_providers_registered() -> None:
    ...
    from edith.mining.cpu_pearl import ensure_registered as ensure_cpu_registered

    ensure_cpu_registered()
    try:
        from edith.mining.apple_mps_pearl import (
...
def init(
    ...
    from edith.core.config import DEFAULT_CONFIG_PATH

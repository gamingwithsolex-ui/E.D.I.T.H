...
from edith.cli._bootstrap import detect_cloud_keys
from edith.cli.model import find_model_spec, hf_download, ollama_pull
from edith.cli.scan_cmd import PrivacyScanner
from edith.core.config import (
    DEFAULT_CONFIG_DIR,
    DEFAULT_CONFIG_PATH,
...
def init(
    ...
    if preset:
        examples_dir = (
            Path(__file__).resolve().parents[2] / "configs" / "edith" / "examples"
        )

...
if TYPE_CHECKING:
    from edith.bench._stubs import BenchmarkResult
...
def run(
    ...
    from edith.bench import ensure_registered
    from edith.bench._stubs import BenchmarkSuite
...
def skills(
    ...
    from edith.evals.skill_benchmark import (

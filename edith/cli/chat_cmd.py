...
def chat(
    ...
    # Resolve engine
    from edith.engine import get_engine
    from edith.intelligence import register_builtin_models
    ...
    if not model:
        from edith.engine import discover_engines, discover_models
    ...
    if agent_key and agent_key != "none":
        try:
            import edith.agents  # noqa: F401 — trigger registration
    ...
    from edith.cli._bg_state import get_status
    from edith.cli._chat_banner import render_startup_banner
    ...
    from edith.cli._chat_notifications import NotificationDispatcher

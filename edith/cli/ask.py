...
from edith.cli._tool_names import resolve_tool_names
from edith.cli.hints import hint_no_engine
...
def _run_research(
    *,
    ...
    from edith.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
    from edith.connectors.embeddings import OllamaEmbedder
    from edith.connectors.hybrid_search import HybridSearch
...
def _run_agent(
    ...
    if "prompt_builder" in _inspect.signature(agent_cls.__init__).parameters:
        from edith.prompt.builder import SystemPromptBuilder

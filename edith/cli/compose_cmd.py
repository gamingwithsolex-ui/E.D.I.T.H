...
def compose_list(kind: Optional[str]) -> None:
    ...
    try:
        from edith.recipes.loader import discover_recipes
...
def compose_show(name: str) -> None:
    ...
    console = Console(stderr=True)
    try:
        from edith.recipes.loader import resolve_recipe
...
def compose_bench(
    ...
    try:
        ...
        from edith.evals.core.config import expand_suite
        ...
        try:
            from edith.evals.cli import _run_single
        except ImportError:
...
def compose_stop(name: str) -> None:
    ...
    try:
        ...
        from edith.recipes.loader import _PROJECT_OPERATORS_DIR

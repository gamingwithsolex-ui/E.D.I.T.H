...
from edith.core.types import Trace, TraceStep
from edith.skills.manager import SkillManager
from edith.skills.overlay import SkillOverlay, write_overlay
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from edith.core.config import DSPyOptimizerConfig
        from edith.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from edith.core.config import GEPAOptimizerConfig
        from edith.learning.agents.gepa_optimizer import GEPAAgentOptimizer

...
if TYPE_CHECKING:
    from edith.agents._stubs import BaseAgent
    ...
    from edith.channels._stubs import BaseChannel
    from edith.learning._stubs import RouterPolicy
    ...
    from edith.security.audit import AuditLogger
    from edith.security.boundary import BoundaryGuard
    ...
    from edith.speech._stubs import SpeechBackend
...
class JarvisSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~edith.channels._stubs.BaseChannel`

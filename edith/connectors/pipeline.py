...
from edith.connectors._stubs import Attachment, Document
from edith.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from edith.connectors.attachment_store import AttachmentStore

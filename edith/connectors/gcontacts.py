...
Uses OAuth 2.0 tokens stored locally (see :mod:`edith.connectors.oauth`).
...
from edith.connectors._stubs import BaseConnector, Document, SyncStatus
from edith.connectors.google_auth import call_with_refresh
from edith.connectors.oauth import (
    GOOGLE_ALL_SCOPES,
...
from edith.core.registry import ConnectorRegistry
from edith.tools._stubs import ToolSpec

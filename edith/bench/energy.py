...
from edith.bench._stats import compute_stats
from edith.bench._stubs import BaseBenchmark, BenchmarkResult
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if energy_monitor is not None:
            from edith.telemetry.steady_state import SteadyStateDetector

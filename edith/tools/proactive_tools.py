...
from edith.core.types import ToolResult
from edith.tools._stubs import BaseTool, ToolSpec
...
def _exec_email_delete(payload: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    try:
        from edith.connectors.gmail import GmailConnector
...
def _exec_calendar_decline(payload: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    try:
        from edith.connectors.gcalendar import GCalendarConnector

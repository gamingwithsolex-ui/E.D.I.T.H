...
def get_rust_module() -> _types.ModuleType:
    ...
    """
    import edith_rust  # type: ignore[import-untyped]
...
def injection_result_from_json(json_str: str) -> object:
    ...
    from edith.security.injection_scanner import (
        InjectionScanResult,
    )
    from edith.security.types import ScanFinding, ThreatLevel
...
def retrieval_results_from_json(json_str: str) -> list:
    ...
    from edith.tools.storage._stubs import RetrievalResult

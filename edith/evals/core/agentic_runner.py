...
from edith.evals.core.event_recorder import AgentEvent, EventRecorder, EventType
from edith.evals.core.trace import QueryTrace, TurnTrace
    ...
    async def _run_single_query(
        ...
        for turn in turns:
            if turn.cost_usd is None and (
                ...
                from edith.evals.core.pricing import compute_turn_cost

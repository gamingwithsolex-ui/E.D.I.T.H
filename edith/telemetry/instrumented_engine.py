...
from edith.core.types import Message, TelemetryRecord
from edith.engine._stubs import InferenceEngine, StreamChunk
from edith.telemetry.gpu_monitor import GpuSample
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~edith.telemetry.energy_monitor.EnergyMonitor`), it is

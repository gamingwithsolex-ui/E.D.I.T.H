...
def create_energy_monitor(
    ...
    try:
        from edith.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from edith.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from edith.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from edith.telemetry.energy_rapl import RaplEnergyMonitor
